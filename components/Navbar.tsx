        ...
        <div className='flex items-center justify-between h-14 sm:h-16'>
          ...
          <div className='flex items-center space-x-1 sm:space-x-2'>
            ...
            <a 
              ...
              className='group border-2 border-emerald-500/20 dark:border-emerald-400/20 text-green-500 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 px-3 py-2 rounded-xl text-sm font-semibold transition-all duration-200 backdrop-blur-sm flex items-center gap-2 hover:scale-105 active:scale-95'
            >
          ...
          <div className='px-2 pt-2 pb-3 space-y-1 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-200/50 dark:border-gray-600/50 mt-2 shadow-lg'>
            ...
            <div className='pt-3 border-t border-gray-200/50 dark:border-gray-600/50'>
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className='flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-700 dark:text-gray-300 hover:text-emerald-600 dark:hover:text-emerald-400 hover:bg-emerald-50/50 dark:hover:bg-emerald-900/20 text-sm font-medium transition-all duration-200 active:scale-95 mt-3'
                onClick={closeMobileMenu}
              >
                <span className='text-base'>🐙</span>
                <span>GitHub</span>
